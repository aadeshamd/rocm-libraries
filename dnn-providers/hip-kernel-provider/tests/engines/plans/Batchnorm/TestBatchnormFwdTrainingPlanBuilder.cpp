...
class TestBatchnormFwdTrainingPlanBuilder : public ::testing::Test
{
protected:
    BatchnormFwdTrainingPlanBuilder _planBuilder;
...
TEST_F(TestBatchnormFwdTrainingPlanBuilder, IsApplicableReturnsTrueForValidSingleNodeGraph)
{
...
TEST_F(TestBatchnormFwdTrainingPlanBuilder, IsApplicableReturnsTrueForValidTwoNodeGraph)
{
...
TEST_F(TestBatchnormFwdTrainingPlanBuilder, IsApplicableReturnsFalseForThreeNodeGraph)
{
    MockGraph mockGraph;
...
TEST_F(TestBatchnormFwdTrainingPlanBuilder, IsApplicableReturnsFalseForWrongNodeType)
{
...
TEST_F(TestBatchnormFwdTrainingPlanBuilder, IsApplicableReturnsFalseForUnsupportedComputeType)
{
    flatbuffers::FlatBufferBuilder builder
...
TEST_F(TestBatchnormFwdTrainingPlanBuilder, IsApplicableReturnsFalseForNonReluActivation)
{
...
TEST_F(TestBatchnormFwdTrainingPlanBuilder, IsApplicableReturnsFalseForWrongNodeOrder)
{
...
TEST_F(TestBatchnormFwdTrainingPlanBuilder,
...
TEST_F(TestBatchnormFwdTrainingPlanBuilder, GetWorkspaceSizeReturnsZero)
{
    MockGraph mockGraph;
...
TEST_F(TestBatchnormFwdTrainingPlanBuilder, BuildPlanSetsPlanForValidSingleNodeGraph)
{
    auto builder = hipdnn_test_sdk::utilities::createValidBatchnormFwdTrainingGraph();
    hipdnn_data_sdk::flatbuffer_utilities::GraphWrapper graph(builder.GetBufferPointer(),
                                                              builder.GetSize());
...
TEST_F(TestBatchnormFwdTrainingPlanBuilder, BuildPlanSetsPlanForValidTwoNodeGraph)
{
    auto builder = hipdnn_test_sdk::utilities::createValidBatchnormFwdTrainingActivGraph();
    hipdnn_data_sdk::flatbuffer_utilities::GraphWrapper graph(builder.GetBufferPointer(),
                                                              builder.GetSize());
...
TEST_F(TestBatchnormFwdTrainingPlanBuilder, BuildPlanThrowsForUnsupportedNodeCount)
{
...
TEST_F(TestBatchnormFwdTrainingPlanBuilder, IsApplicableReturnsFalseForInvalidLayout)
{
...
TEST_F(TestBatchnormFwdTrainingPlanBuilder, IsApplicableReturnsFalseForInvalidDataType)
{
...
TEST_F(TestBatchnormFwdTrainingPlanBuilder, IsApplicableReturnsFalseForInvalidShape)
{
...
TEST_F(TestBatchnormFwdTrainingPlanBuilder, IsApplicableReturnsFalseForNonPackedTensor)
{
...
TEST_F(TestBatchnormFwdTrainingPlanBuilder, IsApplicableReturnsFalseForInsufficientSpatialDims)
{
...
TEST_F(TestBatchnormFwdTrainingPlanBuilder, IsApplicableReturnsFalseForMixedLayouts)
{
