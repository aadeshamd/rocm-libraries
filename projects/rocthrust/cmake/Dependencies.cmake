...
if(BUILD_TEST OR BUILD_HIPSTDPAR_TEST)
  ...
  if(NOT SQLITE_USE_SYSTEM_PACKAGE OR NOT SQLite3_FOUND)
    message(STATUS "SQLite ${SQLITE_MIN_VERSION} not found or force download SQLite on. Downloading and building SQLite.")
